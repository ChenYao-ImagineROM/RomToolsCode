...
BAKSMALIJAR=tools/services/baksmali.jar
SMALIJAR=tools/services/smali.jar
HOST="$(uname)"
VDEXEXTRACTOR="tools/servicesvdexExtractor"
CDEXCONVERTER="tools/services/compact_dex_converter"
...
if [ -z "$ARCHES" ]; then
	echo "检查system是否已odexed并定位boot.otas..."
